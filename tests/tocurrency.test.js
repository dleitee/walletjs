import wallet, { CURRENCY_BRL, DISPLAY_CODE, DISPLAY_SYMBOL, DISPLAY_NAME } from '../src'
...
test('should be returned a currency format', () => {
  ...
  const amount2 = wallet.init(1000, { currency: CURRENCY_BRL })
